...
var file_hello_hello_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x22, 0x1e, 0x0a, 0x08, 0x48, 0x65,
	...
	0x65, 0x32, 0x3d, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x2d, 0x0a, 0x08, 0x67, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x0f, 0x2e,
...
var file_hello_hello_proto_depIdxs = []int32{
	0, // 0: hello.HelloService.greeting:input_type -> hello.HelloReq
	1, // 1: hello.HelloService.greeting:output_type -> hello.HelloResp
...
type HelloServiceClient interface {
	Greeting(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloResp, error)
}
...
func (c *helloServiceClient) Greeting(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloResp, error) {
	out := new(HelloResp)
...
type HelloServiceServer interface {
	Greeting(context.Context, *HelloReq) (*HelloResp, error)
}
...
func (*UnimplementedHelloServiceServer) Greeting(context.Context, *HelloReq) (*HelloResp, error) {
...
func _HelloService_Greeting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).Greeting(ctx, req.(*HelloReq))
	}
